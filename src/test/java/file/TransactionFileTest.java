...
class TransactionFileTest {
    ...
    void addTransactionWithParameters() {
        ...
        parameters = new String[]{"SB" ,"Jon" ,"0" ,"17-11-2024"};
        transactionFile.addTransactionWithParameters(parameters);
        parameters = new String[]{"12313" ,"ohn" ,"me" ,"29-10-2024"};
        transactionFile.addTransactionWithParameters(parameters);
        ...
        assertEquals(transaction1.getStringStartDate() , "17-10-2024");
        ...
        assertEquals(transaction2.getStringStartDate() , "17-11-2024");
        ...
        assertEquals(transaction3.getStringStartDate() , "29-10-2024");
